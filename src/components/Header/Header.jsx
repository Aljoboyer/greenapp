    ...
    <div className='h-fit w-full home_header '>
        ...
        <div className='flex flex-col-reverse lg:flex-row justify-evenly items-center px-10 py-4'>
            <div className='text-center lg:text-start'>
                ...
                <button className='rounded-full bg-[#d9d9d9] text-black hover:text-white hover:bg-[#035762]  ease-in-out duration-300 font-medium font-roboto px-4 py-2'>Download Now !</button>
            </div>
